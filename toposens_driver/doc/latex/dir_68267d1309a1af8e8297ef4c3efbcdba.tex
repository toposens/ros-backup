...
\begin{DoxyCompactList}\small\item\em Implements serial interface to a TS sensor using native Unix command structures. \end{DoxyCompactList}\end{DoxyCompactItemize}
